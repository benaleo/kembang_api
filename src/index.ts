...
import adminProductCategories from './routes/admin-product-categories';
import adminProductStock from './routes/admin-product-stock';
...
app.route('/api/v1/admin/product-categories', adminProductCategories);
app.route('/api/v1/admin/product-stock', adminProductStock);
